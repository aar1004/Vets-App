...
dis_zompaytm = discount = 0.50 * amount
ans_zompaytm = amount - discount
dis_welcome = discount = 0.20 * amount
ans_welcome = amount - discount
if amount >= 159:
    if (ans_zompaytm > ans_welcome):
        print("the zompaytm will be a better promo code")
    elif (ans_zompaytm < ans_welcome):
        print("the welcome50 will be a better promo code")
    else:
        print("u can any above code")
